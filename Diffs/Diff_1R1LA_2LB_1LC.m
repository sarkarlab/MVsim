function dydt = Diff_1R1LA_2LB_1LC(t,y, app) 
...
dydt = zeros(5,1);
dydt(1)=+Koffs.Koff_Receptor1_pos_1_Ligand1_pos_1*y(2)+Koffs.Koff_Receptor1_pos_1_Ligand2_pos_1*y(3)+Koffs.Koff_Receptor1_pos_1_Ligand2_pos_2*y(4)+Koffs.Koff_Receptor1_pos_1_Ligand3_pos_1*y(5)-L1*Kons.Kon_Receptor1_pos_1_Ligand1_pos_1*y(1)-L2*Kons.Kon_Receptor1_pos_1_Ligand2_pos_1*y(1)-L2*Kons.Kon_Receptor1_pos_1_Ligand2_pos_2*y(1)-L3*Kons.Kon_Receptor1_pos_1_Ligand3_pos_1*y(1);
