function dydt = Diff_1R3LA_1LB_2LC(t,y, app) 
...
dydt = zeros(7,1);
dydt(1)=+Koffs.Koff_Receptor1_pos_1_Ligand1_pos_1*y(2)+Koffs.Koff_Receptor1_pos_1_Ligand1_pos_2*y(3)+Koffs.Koff_Receptor1_pos_1_Ligand1_pos_3*y(4)+Koffs.Koff_Receptor1_pos_1_Ligand2_pos_1*y(5)+Koffs.Koff_Receptor1_pos_1_Ligand3_pos_1*y(6)+Koffs.Koff_Receptor1_pos_1_Ligand3_pos_2*y(7)-L1*Kons.Kon_Receptor1_pos_1_Ligand1_pos_1*y(1)-L1*Kons.Kon_Receptor1_pos_1_Ligand1_pos_2*y(1)-L1*Kons.Kon_Receptor1_pos_1_Ligand1_pos_3*y(1)-L2*Kons.Kon_Receptor1_pos_1_Ligand2_pos_1*y(1)-L3*Kons.Kon_Receptor1_pos_1_Ligand3_pos_1*y(1)-L3*Kons.Kon_Receptor1_pos_1_Ligand3_pos_2*y(1);
